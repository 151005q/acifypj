        ...
        <div id="our-services">
            <div class="container padding-top padding-bottom">
                ...
                <div class="row text-center">
                    <div class="col-sm-6 service">
                        <div class="service-content">
                            <asp:Image class="img-responsive" ID="Image3" ImageUrl="~/images/event1.jpg" runat="server" Height="240" width="630"/>
                        </div>
                    </div>
                    <div class="col-sm-6 service">
                        <div class="service-content">
                ...
                <div class="row text-center">
                    <div class="col-sm-6 service">
                        <div class="service-content">
                            <asp:Image class="img-responsive" ID="Image1" ImageUrl="~/images/event2.jpg" runat="server"  Height="240" width="630"/>
                        </div>
                    </div>
                    <div class="col-sm-6 service">
                        <div class="service-content">
                ...
                <div class="row text-center">
                    <div class="col-sm-6 service">
                        <div class="service-content">
                            <asp:Image class="img-responsive" ID="Image2" ImageUrl="~/images/event3.jpg" runat="server"  Height="240" width="630"/>
                        </div>
                    </div>
                    <div class="col-sm-6 service">
                        <div class="service-content">
