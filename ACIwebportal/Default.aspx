        ...
        <div class="col-md-8">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4 ">
                                <asp:TextBox ID="tbFirstName" class="form-control" runat="server" Text="First Name"></asp:TextBox>

                            </div>
                            <div class="col-lg-4 ">
                                <asp:TextBox ID="tbLastName" class="form-control" runat="server" Text="Last Name"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbNRIC" class="form-control" runat="server" Text="NRIC Number"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbEmail" class="form-control" runat="server" Text="Email"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-2 ">
                                <asp:RadioButton ID="RdoMale" Checked="true" Text="Male" GroupName="Gender" runat="server" />
                            </div>
                            <div class="col-lg-2 ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbAddress1" class="form-control" runat="server" Text="Street Address"></asp:TextBox>

                            </div>
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbAddress2" class="form-control" runat="server" Text="Street Address Line 2 (Optional)"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbCity" class="form-control" runat="server" Text="City"></asp:TextBox>

                            </div>
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbRegion" class="form-control" runat="server" Text="Region"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <asp:TextBox ID="tbPostal" class="form-control" runat="server" Text="Postal Code"></asp:TextBox>

                            </div>
                            <div class="col-lg-4">
                                <asp:DropDownList class="form-control" ID="DDLCountry" runat="server"></asp:DropDownList>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <asp:DropDownList class="form-control" ID="ddlCourse" runat="server">
                                    ...
                                    <asp:ListItem>Mobile Usability Design</asp:ListItem>
                                </asp:DropDownList>
